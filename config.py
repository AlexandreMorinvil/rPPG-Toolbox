...
# Number of parallel worker processes used during preprocessing. Each worker
# loads a full video into RAM (~1.5-2 GiB for UBFC-rPPG) and, when BACKEND='Y5F',
# also instantiates its own YOLO5Face model on the GPU. Lower this if you hit
# host RAM or VRAM limits during preprocessing.
_C.TRAIN.DATA.PREPROCESS.NUM_WORKERS = 4
...
_C.VALID.DATA.PREPROCESS.NUM_WORKERS = 4
...
_C.TEST.DATA.PREPROCESS.NUM_WORKERS = 4
...
_C.UNSUPERVISED.DATA.PREPROCESS.NUM_WORKERS = 4
